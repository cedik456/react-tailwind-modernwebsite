      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-6">
          {plans.map((plan, key) => (
            <div
              key={key}
              className={`relative bg-slate-900/50 backdrop-blur-sm  border rounded-xl sm:rounded-2xl p-6 sm:p-8 transition-all duration-200 overflow-visible group flex flex-col h-full ${
                plan.mostPopular
            ...
            >
              ...
              <div className="text-center mb-6 sm:mb-8">
                ...
                <div className="flex items-baseline justify-center">
                  <span className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-linear-to-r from-blue-400 via-blue-200 to-blue-300 bg-clip-text text-transparent ">
                    ${plan.price}
                  </span>
              ...
              <ul className="space-y-2.5 sm:space-y-4 sm:mb-8 flex-row mb-6">
              ...
              <button
                className={` mt-auto w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-semibold sm:text-base transition-all hover:scale-105  justify-center  cursor-pointer duration-300
                   ${
                     plan.mostPopular
                       ? " bg-linear-to-b from-blue-600 to-blue-400"
