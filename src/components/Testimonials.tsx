        ...
        <div className="flex flex-col lg:flex-row items-start gap-8 sm:gap-12 lg:gap-16">
          ...
          <div className="lg:w-1/2 w-full lg:text-left">
            <h2 className="text-5xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6">
              <h2>What developers are saying about us</h2>
            </h2>
                ...
                >
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="shrink-0">
                      <div className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-linear-to-r from-blue-400 via-blue-200 to-blue-300 bg-clip-text text-transparent">
                        "
                      </div>
                    </div>
                    ...
                    <div className="grow ">
                      ...
                      <div className="flex items-center space-x-2">
                        <img
                          ...
                          className="w-10 h-10 rounded-full sm:w-12 sm:h-12 object-cover"
                        />
                        <div>
