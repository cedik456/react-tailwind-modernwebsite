  ...
  return (
    <section className="min-h-screen relative flex items-center pt-16 sm:pt-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto text-center relative w-full ">
        <div className="max-w-7xl mx-auto flex flex-col lg:grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 relative">
          <div>
            <div className="inline-flex items-center px-3 space-x-2 sm:px-4">
              <Sparkles />
